...
public enum HeadEnum {
	...
	PET_GARGOUILLE("MHF_Golem", SourceType.MHF),
	PET_VOUIVRE("MHF_EnderDragon", SourceType.MHF),
	PET_KELPIE("MHF_Squid", SourceType.MHF),
	PET_CAIT_SITH("MHF_Ocelot", SourceType.MHF),
	PET_BLACK_SHUCK("MHF_Wither", SourceType.MHF),
	PET_NEREIDE("MHF_Ghast", SourceType.MHF),
	PET_GEVAUDAN("MHF_Zombie", SourceType.MHF),

	PET_GRIFFON("MHF_Chicken", SourceType.MHF),
	PET_BASILIC("MHF_CaveSpider", SourceType.MHF),
	PET_SELKIE("MHF_Villager", SourceType.MHF),
	PET_TARASQUE("MHF_LavaSlime", SourceType.MHF),
	PET_FARFADET("MHF_Evoker", SourceType.MHF),

	PET_LICORNE("MHF_Sheep", SourceType.MHF),
	PET_SPHINX("MHF_Enderman", SourceType.MHF),
	PET_MORRIGAN("MHF_Witch", SourceType.MHF),
	PET_CERNUNNOS("MHF_Cow", SourceType.MHF),
	PET_HIPPOGRIFFE("MHF_PigZombie", SourceType.MHF),

	PET_FENRIR("MHF_Creeper", SourceType.MHF),
	PET_KRAKEN("MHF_Shulker", SourceType.MHF),
	PET_TARASQUE_ROYALE("MHF_Slime", SourceType.MHF);
