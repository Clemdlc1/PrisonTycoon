...
public class AutominerManager {
    ...
    public ItemStack createAutominer(AutominerType type) {
        ...
        // Nom et lore de base
        meta.setDisplayName("§6⚡ Automineur " + type.getDisplayName() + " ⚡");
    ...
    public AutominerMiningResult simulateMining(ItemStack autominer, String worldName) {
        ...
        for (int i = 0; i < blocksToMine; i++) {
            ...
            if (blockValue != null) {
                blockCoins = blockValue.getCoins() * quantity;
                blockTokens = blockValue.getTokens() * quantity;
                blockExperience = blockValue.getExperience() * quantity;
            }
            ...
            if (blockCoins == 0 && blockTokens == 0 && blockExperience == 0) {
                switch (minedBlock) {
                    case STONE -> {
                        blockCoins = 1 * quantity;
                        blockExperience = 2 * quantity;
                    }
                    case COBBLESTONE -> {
                        blockCoins = 1 * quantity;
                        blockExperience = 2 * quantity;
                    ...
                    case COAL_ORE -> {
                        blockCoins = 5 * quantity;
                        blockTokens = 1 * quantity;
                        blockExperience = 10 * quantity;
                    }
                    case IRON_ORE -> {
                        blockCoins = 10 * quantity;
                        blockTokens = 2 * quantity;
                        blockExperience = 15 * quantity;
                    }
                    case GOLD_ORE -> {
                        blockCoins = 25 * quantity;
                        blockTokens = 5 * quantity;
                        blockExperience = 30 * quantity;
                    }
                    case DIAMOND_ORE -> {
                        blockCoins = 100 * quantity;
                        blockTokens = 20 * quantity;
                        blockExperience = 100 * quantity;
                    }
                    case EMERALD_ORE -> {
                        blockCoins = 150 * quantity;
                        blockTokens = 30 * quantity;
                        blockExperience = 150 * quantity;
                    }
                    case REDSTONE_ORE -> {
                        blockCoins = 15 * quantity;
                        blockTokens = 3 * quantity;
                        blockExperience = 20 * quantity;
                    }
                    case LAPIS_ORE -> {
                        blockCoins = 20 * quantity;
                        blockTokens = 4 * quantity;
                        blockExperience = 25 * quantity;
                    }
                    case ANCIENT_DEBRIS -> {
                        blockCoins = 500 * quantity;
                        blockTokens = 100 * quantity;
                        blockExperience = 500 * quantity;
                    }
                    case NETHERITE_BLOCK -> {
                        blockCoins = 1000 * quantity;
                        blockTokens = 200 * quantity;
                        blockExperience = 1000 * quantity;
                    }
                    case BEACON -> {
                        blockCoins = 2000 * quantity;
                        blockTokens = 500 * quantity;
                        blockExperience = 2000 * quantity;
                    }
                    default -> {
                        // Valeur minimale pour tout autre bloc
                        blockCoins = 1 * quantity;
                        blockExperience = 1 * quantity;
                    }
                }
            }
